---
title: "Description of data Wrangling for Permits Dataset"
output: 
  html_document:
    keep_md: true
    df_print: paged
...
```{r, eval=FALSE}
dat <- read.csv("https://raw.githubusercontent.com/lecy/SyracuseLandBank/master/DATA/PROCESSED_DATA/Permits_processed.csv", stringsAsFactors = F)
