---
title: "Fire and Police Stations"
output:
  html_document:
    keep_md: true
    df_print: paged
...
### Data Visualization
The visualization below shows the location of the Syracuse police and fire stations represented by blue dots.  The interstates are included in orange for spatial context.
```{r}
#Load road data
